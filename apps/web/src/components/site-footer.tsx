...
export function SiteFooter() {
  return (
    <footer className="no-print mt-auto border-t-2 border-ink bg-map-deep text-map-line">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-8 border-t border-map-grid pt-5 text-xs leading-relaxed opacity-75">
          <p>
