  ...
  return (
    <div className="chrome flex min-h-screen flex-col bg-room">
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-10 sm:px-6">
        <h1 className="font-serif text-[2rem] font-bold text-warm">The Pregen Library</h1>
        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {pregeneratedCharacters.map((p) => (
            <article key={p.slug} className="goldenrod-sheet artifact flex flex-col p-4">
        ...
        <p className="mt-10 text-center font-serif italic text-warm-soft">
          Want a table&rsquo;s worth in one go? Roll five in the{" "}
          <Link href="/character-creator" prefetch={false} className="text-brass underline underline-offset-2">
            creator
          </Link>{" "}
